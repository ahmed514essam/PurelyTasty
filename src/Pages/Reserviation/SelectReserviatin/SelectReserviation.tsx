...
useEffect(() => {
    const storeEmail = localStorage.getItem("emailuser") || null;
    

    setEmail(JSON.parse(storeEmail));
    ...
    fetch("https://sendmail-api-docs.vercel.app/api/send", {
        ...
        body: JSON.stringify({
            ...
            subject: `Message from Savor Resturant `,
...
<select  name="categ" value={categ} onChange={(e) => setCateg(e.target.value)} required>
...
<button onClick={DoneTime}  className={style.btnsDone} >Done</button>
